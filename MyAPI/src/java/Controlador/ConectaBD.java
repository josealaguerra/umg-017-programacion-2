...
public class ConectaBD {
    ...
    public ConectaBD() throws Exception{
        try{  
            ...
            conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/myapi","apiuser","apiuser");  
        } catch (SQLException ex) {
            Util.printSQLException("ConectaBD.ConectaBD", ex);
            throw new Exception("Imposible conectarse a la BD: myapi", ex);
        } catch (Exception e) {
            Util.printException("ConectaBD.ConectaBD", e);
            throw new Exception("Imposible conectarse a la BD: myapi", e);            
        }
    }  
