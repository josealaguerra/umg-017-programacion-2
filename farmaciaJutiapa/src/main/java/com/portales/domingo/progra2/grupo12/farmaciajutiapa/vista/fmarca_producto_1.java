 ...
 */
public class fmarca_producto_1 extends javax.swing.JFrame {

    /**
     * Creates new form fmarca_producto
     */
    public fmarca_producto_1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmarca_producto_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fmarca_producto_1().setVisible(true);
            }
        });
    }
